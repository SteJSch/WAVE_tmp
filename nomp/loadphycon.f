*CMZ :          14/05/2024  10.01.28  by  Michael Scheer
*-- Author :    Michael Scheer   14/05/2024
      subroutine loadphycon
*KEEP,PHYCON.
      DOUBLE PRECISION
...
c{ SEQ,PYCON1.
     ...
     &  *EMASSKG1/HBAR1/ERAD1*EMASSG1**5
      ...
      ecdipkev1=3.0d0/2.0d0*hbarev1*(clight1/emasse1)**2/emasse1*1.0d15
      ecdipev1=ecdipkev1*1000.0d0
